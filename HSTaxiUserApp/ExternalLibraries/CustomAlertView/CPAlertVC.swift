...
//        }
    ...
    override func viewDidLoad() {
        ...
        alertView.backgroundColor = UIColor(named: "EXTRA_VIEW") ?? .white
    ...
    private func setupUI() {
        titleLabel.textColor = UIColor(named: "PRIMARY_COLOR") ?? .white
        messageLabel.textColor = UIColor(named: "TEXT_COLOR") ?? .white
    ...
    private func setupButton() {
        ...
        self.posButton.setTitleColor(UIColor(named: "PRIMARY_COLOR") ?? .white, for: .normal)
